...
/*	$FreeBSD: releng/11.1/sys/dev/usb/wlan/if_zyd.c 314222 2017-02-24 21:19:40Z avos $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: releng/11.1/sys/dev/usb/wlan/if_zyd.c 314222 2017-02-24 21:19:40Z avos $");
